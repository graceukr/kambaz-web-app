    ...
    <div id="wd-asynchronous-arrays">
      ...
      <h4>Todos 
        <FaPlusCircle onClick={createTodo} className="text-success float-end fs-3"
                         id="wd-create-todo" /> 
        <FaPlusCircle onClick={postTodo} className="text-primary float-end me-3 fs-3"
                         id="wd-post-todo" /> 
      </h4>
      <ListGroup>
        {todos.map((todo) => (
          <ListGroup.Item key={todo.id}>
            ...
            <TiDelete onClick={() => deleteTodo(todo)} className="text-danger float-end me-1 fs-3" id="wd-delete-todo" />
